...
public class MapsActivityRoute extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(10.0089200, 76.3615900);
